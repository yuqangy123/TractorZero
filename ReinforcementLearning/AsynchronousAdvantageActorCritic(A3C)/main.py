...
if __name__ == '__main__':
    ...
    workers = [model.Worker(gnet, opt, global_ep, global_ep_r, res_queue, i, N_S, N_A) for i in range(mp.cpu_count())]
    # workers = [model.Worker(gnet, opt, global_ep, global_ep_r, res_queue, 0, N_S, N_A)]
