...
# infoset['win_score_limit'] = get_full_hot_array(bid_score//5, __MAX_SCORE__)
def get_obs(infoset):
    ...
    win_score_limit = infoset.win_score_limit
    win_score_batch = np.repeat(win_score_limit[np.newaxis, :],
                                    num_legal_actions, axis=0)
