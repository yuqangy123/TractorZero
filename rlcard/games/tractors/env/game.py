...
class InfoSet(object):
    def __init__(self, player_position):
        ...
        self.landlord_play_action_seq = None
        self.landlord_down_play_action_seq = None
        self.landlord_up_play_action_seq = None
...
class GameEnv(tractors):
    ...
    def reset(self):
        ...
        self.coving_player_position = None
       ...
       ##########################################################################
        ...
        self.landlord_play_action_seq = []
        
        self.landlord_down_play_action_seq = []
        
        self.landlord_up_play_action_seq = []
        ...
        self.init_position_hand_cards = {'landlord': [], 'landlord_up': [], 'landlord_down': []}
    ...
    def step(self, response):
                    ...
                    if self.stage == "bid":
                        ...
                        self.bid_infoset.mask_bid_score = self.bid_infoset.bid_score - 5
                    ...
                    #埋牌阶段(无埋牌阶段)
                        ...
                        rule = 'banker'
                        if banker != play_pos:
                            rule = 'banker_down' if (play_pos+1)%__PLAYER_COUNT__ == banker else 'banker_up'
                        self.game_infoset[rule].
